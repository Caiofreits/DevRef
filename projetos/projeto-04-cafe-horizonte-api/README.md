...
API própria (Node.js + Express + MongoDB/Mongoose) para o cardápio e as reservas do Café Horizonte, construída seguindo o projeto guiado da apostila 04. Substitui o cardápio estático e o JSON simulado usados pela versão React até então.
...
| `npm run seed` | Limpa a coleção `menuitems` e recria os 5 itens de exemplo, copiando as imagens de `projeto-03-cafe-horizonte-react/public/img`. |
